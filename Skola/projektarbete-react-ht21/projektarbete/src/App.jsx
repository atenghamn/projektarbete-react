...
function App() {
  ...
  const [images, setImages] = useState([
    {img: imageTen, key: 1, caption: "In the middle of rush hour we had to get these photos for an upcomming theatershow. I was on parental leave but the job sounded to fun to pass down. While I directed the two actors with hoods over their heads, my then 1-yeard old daughter, played in the background. A lot of people walked by. Nobody said anything."},
    {img: imageTwo, key: 2, caption: "While driving back from the Bergman museum in Fårö, Gotland i spotted these fishing huts. Cliché as fuck..."},
    {img: imageThree, key: 3, caption: "I shot alot of actors over the years. It's a bit strange that actors often aren't very good at posing naturaly, instead they often want directions on how to stand, and look. Sanne, is an amazingly talented actress that been seen in productions like the tv-series Bron.  She's one of few actors that can look sincere in a picture."},
    {img: imageFour, key: 4, caption: "Mattias a musician. A harmonica player. I shot this portrait of him a time after he lost his son. Theres no more words to be said around this picture."},
    {img: imageFive, key: 5, caption: "A personal image. Made for myself. Driving back from my mom, I saw this house that I never seen before. Got out, set up, pressed the shutter, drove off. A common ritual."},
    {img: imageSix, key: 6, caption: "Jmag's behid everything skateboardrelated in Sweden. Need a skatepark? Call Jmag! I shot a lot of photos of Jmag over the years, a lot of skateboard ads. While shoting this picture we had to carry the barrel from an nearby industry, Jmag complained that his hands were itching after he carried the barrel. Maybe he's radioactive now..?"},
